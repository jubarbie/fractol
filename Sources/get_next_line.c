...
/*   Updated: 2016/03/24 19:19:22 by jubarbie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

void	free_all(char **line, t_list **first, int fd)
{
	t_list	*todel;
	t_list	*prev;
...
t_list	*search_fd(t_list **first, int fd)
{
	t_list	*elem;
...
int		treat_buff(int fd, char *buff, char **line)
{
	int		i;
	int		nl;
	int		ret;
