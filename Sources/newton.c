...
/*   Updated: 2016/06/07 10:33:51 by jubarbie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	fract_calc(t_param *param)
{
	...
	tmp = Z_R;
	C_R = 3.0 * ((Z_R * Z_R - Z_I * Z_I) * (Z_R * Z_R - Z_I * Z_I) +
			4.0 * Z_R * Z_R * Z_I * Z_I) + V;
	if (C_R == 0.0)
		C_R = 0.00001;
...
static void	draw_fract(int x, int y, t_param *param)
{
	if (Z_R > 0.0)
